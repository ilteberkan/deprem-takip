    ...
    return (
      <div className="container mx-auto p-4">
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
          <p className="text-red-600">Veri yüklenirken bir hata oluştu. Lütfen sayfayı yenileyin.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
        ...
        <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-1">
          {earthquakes?.map((earthquake) => (
            ...
            >
              <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg border border-gray-100">
                <div className="flex">
                  ...
                  <div className="w-24 sm:w-32 flex-shrink-0 flex flex-col">
                    ...
                    <div className="h-16 bg-gray-50 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <div className="text-sm text-gray-500 font-medium">Büyüklük</div>
                      </div>
                    </div>
                  </div>
