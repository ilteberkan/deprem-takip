    ...
    <div className="min-h-screen bg-gray-50 safe-area-top safe-area-bottom">
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <button
            onClick={() => router.push('/')}
            className="flex items-center gap-2 px-6 py-3 bg-gray-600 text-white rounded-xl hover:bg-gray-700 transition-all duration-200 shadow-sm hover:shadow-md"
          >
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-8 mb-8">
            ...
            <div className="flex-1">
              <h1 className="text-3xl font-bold text-gray-800 mb-2">{earthquake.location}</h1>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  <div className="text-sm text-gray-500 mb-1">Büyüklük</div>
                  <div className="text-lg font-bold text-gray-800">{earthquake.magnitude}</div>
                </div>
                <div className="bg-gray-50 rounded-xl p-4">
                  <div className="text-sm text-gray-500 mb-1">Derinlik</div>
                  <div className="text-lg font-bold text-gray-800">{earthquake.depth} km</div>
                </div>
                <div className="bg-gray-50 rounded-xl p-4">
                  <div className="text-sm text-gray-500 mb-1">Koordinatlar</div>
                  <div className="text-lg font-bold text-gray-800">
          ...
          {session ? (
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <textarea
                    ...
                    className="w-full p-4 border rounded-xl focus:ring-2 focus:ring-red-500 focus:border-transparent bg-gray-50"
            ...
            <div className="bg-gray-50 rounded-xl p-6 mb-8">
              <div className="text-center">
                <p className="text-gray-600 mb-4">Yorum yapmak için giriş yapın</p>
                <button
                  onClick={() => signIn('google')}
                  className="inline-flex items-center gap-2 px-6 py-2.5 bg-white border border-gray-300 rounded-xl text-gray-700 hover:bg-gray-50 transition-colors shadow-sm"
                >
                  <Image
                    src="/google-icon.png"
                    alt="Google"
          ...
          <div className="space-y-6">
            {isCommentsLoading ? (
              ...
              <div className="text-center py-8">
                <div className="text-gray-500 mb-2">Henüz yorum yapılmamış</div>
                <div className="text-sm text-gray-400">İlk yorumu siz yapın!</div>
              </div>
            )}
          </div>
        </div>
